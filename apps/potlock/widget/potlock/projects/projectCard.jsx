...
const body = (
  <Details>
    <Container>
      <a
        href={`/nearhorizon.near/widget/Index?tab=project&accountId=${props.accountId}`}
      >
        <Widget
          src={`nearhorizon.near/widget/Project.Icon`}
      ...
      <Details>
        ...
        >
          <Widget
            src={`nearhorizon.near/widget/NameAndAccount`}
            props={{
        ...
        <Widget
          src={`nearhorizon.near/widget/Tags`}
          props={{ tags: state.profile.verticals }}
        />
        {/*<Widget
          src={`nearhorizon.near/widget/BadgeList`}
          props={{
            badges: [
              { value: "Verified" },
    ...
    {false ? (
      <Row>
        <Widget
          src={`nearhorizon.near/widget/IconList`}
          props={{ ids: state.founders }}
        />
        <Requests
          href={`/nearhorizon.near/widget/Index?tab=project&content=requests&accountId=${accountId}`}
        >
          <svg
            width="19"
            height="14"
...
if (large) {
  return (
    <Widget src={`nearhorizon.near/widget/Card`} props={{ body, footer }} />
  );
}

return <Widget src={`nearhorizon.near/widget/Card`} props={{ body }} />;
